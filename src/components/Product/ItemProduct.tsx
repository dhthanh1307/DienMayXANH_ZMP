...
export const ProductItem: FC<{ product: Product }> = ({ product }) => {
    ...
    return (
        <div onClick={() => handleDetail(product)} className="flex h-400 w-44 flex-wrap justify-center rounded-lg border border-gray-300">
            ...
            <div className="flex h-150  w-160  items-center justify-center">
                <img src={product.thumbnail} className="w-32" />
            </div>
            <div className="m-2 w-full text-12">
                {product.warrantyInformation && (
                    <div className="mb-1 flex h-5 w-3/4 items-center gap-1 rounded-2xl bg-red-600  ">
                ...
                <div  >
                    <div className="my-1 text-14 font-bold text-red-600">
                ...
                <div className="my-1 flex items-center gap-2 text-gray-600">
                    <div>
