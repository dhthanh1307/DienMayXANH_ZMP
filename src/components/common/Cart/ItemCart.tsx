    ...
    return (
        <div className="m-2.5 flex text-12">
            ...
            <div className="w-full ">
                ...
                <div className="my-2">
                    <span className="rounded-md bg-softgray p-1"> Màu trắng</span>
                </div>
                <div>
                    ...
                    {/* <div tabIndex={0} className=" w-270 rounded-md bg-softgray text-12 text-gray-500">
                        <div className="m-2">
                            <div className="font-bold">Chính sách Online giá rẻ quá</div>
                            <div><li>Giao hàng nhanh chóng (tùy khu vực)</li></div>
                            <div><li>Mỗi số điện thoại chỉ mua được 3 sản phẩm trong 1 tháng</li></div>
                        </div>
                    </div> */}
                </div>
                <div className=" text-navi">3 khuyến mãi</div>
