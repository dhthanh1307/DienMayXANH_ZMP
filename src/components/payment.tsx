...
export const PayMent: FC<{ product: Product }> = ({ product }) => {
    return (
        <div className="bg-red-600 h-12 mt-2 rounded-xl h-96 text-white">
            <div className="flex p-2">
                <div>
                    <div className="text-white text-[18px] font-bold">
                        Online giá rẻ quá
                    </div>
                    <div className="text-yellow-300 text-[36px] font-bold my-2">
                        {product.price} $
                    </div>
                    <div  >
                ...
                <div className="ms-16 mx-auto">
                    ...
                    <div className="h-2 text-[10px] my-1  bg-yellow-100 w-[170px] rounded-xl text-center flex"
                        style={{
            ...
            <div className="m-2 rounded-lg h-[270px] bg-gray-100">
                <div className="bg-yellow-100 h-[80px] m-2 rounded-lg text-red-400 ">
                    <div className="p-2">
                        <li>
                            Không áp dụng kèm khuyến mãi khác
                        </li>
                        <li>
                            Không áp dụng mua buôn/mua sỉ
                        </li>
                        <li>
                            1 số điện thoại mua được 2 sản phẩm
                        </li>
                    </div>
                ...
                <div className="dflex h-8 my-2">
                    ...
                    <div className="flex mx-2 my-1 border p-1 rounded-lg">
                        ...
                        <div className="h-10">
                            ...
                            <p className="text-[12px] text-gray-300 ms-4">
                    ...
                    <div className="flex gap-2 h-12 mx-2">
                        <div className="h-12 border border-blue-400 flex text-center rounded-lg items-center justify-center w-1/2">
