    ...
    return (
        <div className="flex flex-wrap items-center justify-center bg-white py-4 pe-2.5">
            {displayed.map((promotion, index) => (
                <div onClick={() => handleDetail(promotion)} key={index} className="w-1/2 ps-2.5 pb-2.5">
                    <div className="border border-gray-100 rounded-lg px-2">
                        <div className="flex h-150 items-center justify-center pt-4">
                            <img src={promotion.thumbnail} className="h-36" />
                        </div>
                        <div className="text-12 mt-2.5">
                            <div className="h-10 ">
                                {promotion.title}
                            </div>
                            <div className="mt-2" >
                                <div className="text-14 font-bold text-red-600">
